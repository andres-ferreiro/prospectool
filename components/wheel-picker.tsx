...
function WheelPickerWrapper({
  ...
  return (
    <WheelPickerPrimitive.WheelPickerWrapper
      className={cn(
        // The library's own CSS sets [data-rwp-wrapper]{width:100%} with the
        // same specificity as this Tailwind utility — without !important,
        // source order (not our class) decides the winner, and the wheel
        // collapses to ~0 width since none of its content sizes in-flow.
